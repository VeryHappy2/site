...
app.UseEndpoints(endpoints =>
{
	...
	endpoints.MapControllerRoute("order", "{controller=Order}/{action=Index}/{id?}");

	endpoints.MapControllerRoute("basket", "{controller=Basket}/{action=Index}/{id?}");
	endpoints.MapControllerRoute("deleteBasketProduct", "{controller=Basket}/{action=DeleteProduct}/{id?}");
	endpoints.MapControllerRoute("deleteBasket", "{controller=Basket}/{action=DeleteBasket}");

	endpoints.MapControllerRoute("About", "{controller=About}/{action=Index}/{id?}");
